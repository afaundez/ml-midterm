...
\begin{equation}
  \argmin_{c_k \in C} \sum_{j = 1}^{K} e(c_j, c_k)P(c_j, d)
\end{equation}
...
To run the code is necessary a Unix environment with Ruby 2.6+. The code is available on GitHub at https://github.com/afaundez/ml-midterm.
